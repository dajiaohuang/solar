...
The SHA-256-pinned, on-demand SPK pack has two profiles, each with 499 files: Pages is **227.4 MiB** (238,471,168 bytes); full/native is **563.8 MiB** (591,139,840 bytes). At UTC JD 2461287.5, tests resolve **489 selectable body centers**. Full satellite additions cover 2020–2031 TDB; Pages preserves the same target identities but narrows large inner-moon files to 2026–2027. Original type 2/3/17/21 records retain explicit DE437/DE440/DE441/DE442 center dependencies. Independent CSPICE tests check 433 added source pools at 1,299 epochs; numerical agreement is not physical uncertainty.
