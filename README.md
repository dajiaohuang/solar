...
The SHA-256-pinned, on-demand SPK pack has two profiles, each with 502 files: Pages is **235.8 MiB** (247,241,728 bytes); full/native is **647.4 MiB** (678,845,440 bytes). At UTC JD 2461287.5, tests resolve **492 selectable body centers**. Full satellite additions cover 2020–2031 TDB; Pages preserves the same target identities but narrows large satellite files to 2026–2027. Original type 2/3/17/21 records retain explicit DE437/DE440/DE441/DE442 center dependencies. Independent CSPICE tests check 436 added source pools at 1,308 epochs; numerical agreement is not physical uncertainty.
