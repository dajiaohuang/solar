...
The SHA-256-pinned, on-demand SPK pack has two profiles, each with 507 files: Pages is **249.9 MiB** (262,033,408 bytes); full/native is **927.0 MiB** (972,007,424 bytes). At UTC JD 2461287.5, tests resolve **502 selectable body centers**. Full planetary-satellite additions cover 2020–2031 TDB; Pages narrows large satellite files to 2026–2027. Five new small-body binary systems span 2020-01-01/2030-01-01 in full and 2026-07-01/2027-01-01 in Pages, retaining the same target identities. Original type 2/3/17/21 records retain explicit source-specific center dependencies. Independent CSPICE tests check 441 added source pools with 1,353 position/velocity sample pairs; numerical agreement is not physical uncertainty.
