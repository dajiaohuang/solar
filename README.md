...
- **Observation Deck:** eleven one-click scene presets, including Earth–Moon, Jupiter’s four modeled Galilean moons, Saturn–Titan, and Mars–Ceres–Jupiter; a fast 2D first view with immediate 3D switching; a bounded simulation clock; arbitrary body-centered and split reference frames; searchable render-body selection; trajectory, layer, zoom, and camera controls; distance measurement; Lagrange points; Hill spheres and Laplace SOIs.
