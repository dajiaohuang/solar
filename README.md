...
The preview profile now adds SAT456 identities NAIF 619–622; its next curated closure is 41 SPK files totaling 92,071,936 bytes. The published Pages deployment remains the earlier 36-file snapshot until this profile is deployed.

The SHA-256-pinned, on-demand Web/backend **source profiles** have two variants, each with 612 files: the Pages profile is **260.5 MiB** (273,137,664 bytes), while full Web/backend is **1115.7 MiB** (1,169,903,616 bytes). The currently published Pages preview is a separate curated closure of 36 SPK files totaling 90,687,488 bytes; its online capacity report is 93.2 MiB overall, so it must not be confused with the 612-file Pages source profile. At UTC JD 2461287.5, the source integration tests resolve **599 selectable body centers**; this is not a promise of native coverage or a complete offline ephemeris. Full planetary-satellite additions cover 2020–2031 TDB; Pages narrows large satellite files to 2026–2027. Eight new small-body binary systems plus one hundred and six frozen Horizons type-21 asteroid snapshots, including Sedna, Arawn, Ixion, Gonggong and Varda (Pallas, Vesta, Hygiea, Psyche, Ida, Eros, Gaspra, Itokawa, Apophis, Ryugu, Phaethon, Florence, Didymos, Toutatis, Ganymed, Betulia, Steins, 1998 OR2, 1950 DA, 2001 FO32, Arrokoth, APL, Dinkinesh, 2008 EV5, Kamoʻoalewa, 2000 ET70, 2001 SN263, 2005 YU55, 2003 SD220, 2004 BL86, Duende, Hebe, Metis, Irene, Melpomene, Fortuna, Antiope, Kleopatra, Parthenope, Egeria, Lutetia, Themis, Amphitrite, Laetitia, Nysa, Astraea, Flora, Victoria, Massalia, Harmonia, Cruithne, Golevka, 1986 DA, Besixdouze, Torifune, Kalliope, Eugenia, Minerva, Hermione, Elektra, Juno, Iris, Euphrosyne, Europa, Cybele, Phocaea, Euterpe, Urania, Circe, Fides, Sylvia, Camilla, Davida, Interamnia, Thetis, Thalia, Proserpina, Bellona, Pomona, Nemausa, Chiron, Pholus, Chariklo, Varuna, Eunomia, Thisbe, Hektor, Agamemnon, Polyhymnia, Leukothea, Atalante, Leda, Daphne, Hestia, Doris and Pales) are included; the latter cover 2020–2031 in full and 2026–2027 in Pages, with response and binary hashes retained. The fourteen outer-system additions (Chiron, Pholus, Chariklo, Varuna, Sedna, Arawn, Ixion, Gonggong, Varda, Makemake, 2002 UX25, 2002 TC302, 2005 RM43 and 2005 RN43) are direct target-center states only; their common Centaur/TNO labels are contextual catalog categories, not a claim of a shared dynamical fit, companions or measured physical properties. Eunomia and Thisbe use direct Horizons identities rather than generic SB441 target spellings. All frozen Horizons entries are direct primary heliocentric states only; no companion or system-center state is delivered, and no binary coverage is implied. Bennu remains an explicit Horizons-generation gap. Original type 2/3/17/21 records retain explicit source-specific center dependencies. Independent CSPICE tests check 444 added source pools with 1,422 position/velocity sample pairs; numerical agreement is not physical uncertainty.

This is not universal coverage: S/2009 S1 has no corroborated SPK target or state in the source pack. Daphnis uses original historical SAT393 records. Makemake now has a direct Horizons target-center SPK in batch 20; it remains a direct primary state rather than a companion-system solution. Eris/Haumea primary centers and their moons end at 2030-01-02 TDB. Missing states never receive invented orbits. Native clients do not package these SPK profiles; they receive exact current states through the manifest/plan/binary-tile protocol. Manifest and plan loading remains online, while already verified tiles may be reused from the native cache. See the [profile and regeneration contract](./docs/physical-ephemerides.md) and [satellite evidence workflow](./scripts/reference/SATELLITE-SURVEY.md).
