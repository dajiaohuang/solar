...
export function EvidenceWorkspace() {
  ...
  return <div className="workspace-page evidence-workspace">
    ...
    <div className="evidence-grid">
      ...
      <section className="evidence-module source-links glass-panel"><div className="module-heading"><span>{t('source')}</span><em>PRIMARY</em></div><a href="https://www.minorplanetcenter.net/iau/MPCORB.html" target="_blank" rel="noreferrer"><span>MPCORB</span><small>{t('mpcSourceDescription')}</small><b>↗</b></a><a href="https://ssd-api.jpl.nasa.gov/doc/sbdb.html" target="_blank" rel="noreferrer"><span>JPL SBDB API</span><small>{t('sbdbSourceDescription')}</small><b>↗</b></a><a href="https://ssd.jpl.nasa.gov/planets/approx_pos.html" target="_blank" rel="noreferrer"><span>JPL approximate positions</span><small>{t('jplSourceDescription')}</small><b>↗</b></a><a href="https://ssd.jpl.nasa.gov/sats/elem/" target="_blank" rel="noreferrer"><span>JPL satellite mean elements</span><small>{t('jplSatelliteSourceDescription')}</small><b>↗</b></a><a href={EARTH_MOON_MASS_PARTITION_EVIDENCE.sourceUrl} target="_blank" rel="noreferrer"><span>NAIF/JPL DE440 GM</span><small>{t('de440GmSourceDescription')}</small><b>↗</b></a></section>
