...
export function EvidenceWorkspace() {
  ...
  return <div className="workspace-page evidence-workspace">
    ...
    <div className="evidence-grid">
      ...
      <section className="evidence-module glass-panel"><div className="module-heading"><span>Scientific contract</span><em>MODELS</em></div><dl className="contract-list"><div><dt>Major planets</dt><dd>JPL approximate orbital elements with secular rates; suitable for broad visualization.</dd></div><div><dt>Curated bodies</dt><dd>Rounded educational elements for selected moons and dwarf planets, labeled curated-approx rather than live JPL data.</dd></div><div><dt>Small bodies</dt><dd>Elliptic two-body propagation from an osculating MPCORB or JPL SBDB epoch.</dd></div><div><dt>Spacecraft</dt><dd>Milestone-dated schematic paths, explicitly separated from Horizons and operational ephemerides.</dd></div><div><dt>Events</dt><dd>Explicit, bounded analysis of non-endpoint local extrema, refined by three-point parabolic interpolation. Results do not auto-update during playback.</dd></div><div><dt>Missions</dt><dd>Circular Hohmann baseline and universal-variable Lambert solution; no N-body correction.</dd></div><div><dt>Scene links</dt><dd>Carry dataset version, epoch, frame, selection, filters, and view state.</dd></div></dl></section>
