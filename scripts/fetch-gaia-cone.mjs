...
async function main() {
  ...
  try {
    ...
    const implementation = { node: process.version, generatorSha256: sha256(await readFile(new URL(import.meta.url))), parserSha256: sha256(await readFile(new URL('./lib/gaia-dr3.mjs', import.meta.url))) }
