...
const cache = process.env.SOLAR_HORIZONS_ASTEROID_BATCH16_CACHE ?? '.cache/horizons-asteroids-batch16-20260910'
const output = 'public/data/ephemerides'
const batch = 'horizons-asteroids-batch16-20260910'
const coreId = 'de440s-2000-01-01-2051-01-01'
const targets = [
  ['polyhymnia', 'Polyhymnia', 33, 20000033],
  ['leukothea', 'Leukothea', 35, 20000035],
  ['atalante', 'Atalante', 36, 20000036],
  ['leda', 'Leda', 38, 20000038],
]
