...
const cache = process.env.SOLAR_HORIZONS_ASTEROID_BATCH14_CACHE ?? '.cache/horizons-asteroids-batch14-20260909'
const output = 'public/data/ephemerides'
const batch = 'horizons-asteroids-batch14-20260909'
const coreId = 'de440s-2000-01-01-2051-01-01'
const targets = [
  ['nemausa', 'Nemausa', 51, 20000051],
  ['chiron', 'Chiron', 2060, 20002060],
  ['pholus', 'Pholus', 5145, 20005145],
  ['chariklo', 'Chariklo', 10199, 20010199],
  ['varuna', 'Varuna', 20000, 20020000],
]
