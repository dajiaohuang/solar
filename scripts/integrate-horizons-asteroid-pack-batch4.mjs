...
// The cache is the release input: each response carries binary and raw
// response hashes before publication. Original type-21 records are retained;
// no refit, extrapolation or N-body model is introduced.
import { createHash } from 'node:crypto'
import { mkdir, readFile, writeFile } from 'node:fs/promises'
import { join } from 'node:path'
import { cropSpk } from './crop-spk.mjs'

const cache = process.env.SOLAR_HORIZONS_ASTEROID_BATCH4_CACHE ?? '.cache/horizons-asteroids-batch4-20260909'
const output = 'public/data/ephemerides'
const batch = 'horizons-asteroids-batch4-20260909'
const coreId = 'de440s-2000-01-01-2051-01-01'
const targets = [
  ['parthenope', 'Parthenope', 11, 20000011],
  ['egeria', 'Egeria', 13, 20000013],
  ['lutetia', 'Lutetia', 21, 20000021],
  ['themis', 'Themis', 24, 20000024],
  ['amphitrite', 'Amphitrite', 29, 20000029],
  ['laetitia', 'Laetitia', 39, 20000039],
  ['nysa', 'Nysa', 44, 20000044],
]
