...
for (const source of ['NativeObservationDeck.swift', 'StateTileDecoder.swift', 'StateTileCache.swift', 'StateTileService.swift', 'NativeStateProjection.swift', 'NativeCoverageReport.swift', 'NativeGroundContacts.swift', 'NativeStellarMotion.swift', 'NativeStellarMotionView.swift', 'NativeGroundContactView.swift', 'NativePointGeometry.swift', 'NativeSourceIdentityPage.swift', 'NativeSourceDirectory.swift']) {
