// Integrate locally frozen NASA/JPL Horizons type-21 SPKs for named TNO primaries.
import { createHash } from 'node:crypto'
import { mkdir, readFile, writeFile } from 'node:fs/promises'
import { join } from 'node:path'
import { cropSpk } from './crop-spk.mjs'

const cache = process.env.SOLAR_HORIZONS_ASTEROID_BATCH34_CACHE ?? '.cache/horizons-tno-batch34-20260914'
const output = 'public/data/ephemerides'
const batch = 'horizons-tno-batch34-20260914'
const coreId = 'de440s-2000-01-01-2051-01-01'
const targets = [
  ['teharonhiawako', '88611 Teharonhiawako', '88611', 20088611],
  ['mors-somnus', '341520 Mors-Somnus', '341520', 20341520],
]
