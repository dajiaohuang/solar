...
const cache = process.env.SOLAR_HORIZONS_ASTEROID_BATCH31_CACHE ?? '.cache/horizons-centaur-batch31-20260914'
const output = 'public/data/ephemerides'
const batch = 'horizons-centaur-batch31-20260914'
const coreId = 'de440s-2000-01-01-2051-01-01'
const targets = [
  ['typhon', '42355 Typhon', '42355', 20042355],
  ['orius', '330836 Orius', '330836', 20330836],
  ['eurytus', '463368 Eurytus', '463368', 20463368],
]
