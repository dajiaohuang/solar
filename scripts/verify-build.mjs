...
if (spkDelivery?.ephemerisBodyCount !== 303 || spkDelivery?.planetarySatelliteBodyCount !== 152 || spkDelivery?.smallBodyBodyCount !== 151 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== '673b0d0dc30fba34cf39f7383736aa9a6eda17491995b7c67e07bc90a559f6c8' || spkDelivery?.pagesManifest?.bytes !== 274119680 || spkDelivery?.pagesManifest?.fileCount !== 657) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== 'dbe7dd3841fb32dbcb56ba0a08e1494f7e246f6bf7bcdce788f11e263a837f87' || spkDelivery?.fullManifest?.bytes !== 1179160576 || spkDelivery?.fullManifest?.fileCount !== 657) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
