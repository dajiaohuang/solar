...
if (spkDelivery?.ephemerisBodyCount !== 92 || spkDelivery?.planetarySatelliteBodyCount !== 31 || spkDelivery?.smallBodyBodyCount !== 61 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== 'bbfe368826fbeab4c5d663e15c7921d614b6efb490ac5206129ef77d48e008ee' || spkDelivery?.pagesManifest?.bytes !== 271935488 || spkDelivery?.pagesManifest?.fileCount !== 556) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== 'c1c48f2dc3dfd29de8b3a816854de5ba149cc09fab7d813ff0bc36ea12d51523' || spkDelivery?.fullManifest?.bytes !== 1157643264 || spkDelivery?.fullManifest?.fileCount !== 556) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
...
if (JSON.stringify(spkDelivery?.frozenHorizonsAsteroids) !== JSON.stringify(['243', '433', '951', '25143', '99942', '162173', '3200', '3122', '65803', '4179', '1036', '1580', '2867', '52768', '29075', '231937', '486958', '132524', '152830', '341843', '469219', '162421', '153591', '308635', '163899', '357439', '367943', '6', '9', '14', '18', '19', '90', '216', '11', '13', '21', '24', '29', '39', '44', '5', '8', '12', '20', '40'])) throw new Error('Scientific validation report is missing the frozen Horizons asteroid batch')
