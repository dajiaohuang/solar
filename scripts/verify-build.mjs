...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== 'b3f035db6d68c5d5e29dce30ce66d3011fe5e272d46d70fa4a5261b1234679e5' || spkDelivery?.pagesManifest?.bytes !== 272161792 || spkDelivery?.pagesManifest?.fileCount !== 566) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== '4e6f0bb6e217311f472a702b81a32d5ab691f86fde78c8e6b900539fa55add80' || spkDelivery?.fullManifest?.bytes !== 1159735296 || spkDelivery?.fullManifest?.fileCount !== 566) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
...
if (JSON.stringify(spkDelivery?.frozenHorizonsAsteroids) !== JSON.stringify(['243', '433', '951', '25143', '99942', '162173', '3200', '3122', '65803', '4179', '1036', '1580', '2867', '52768', '29075', '231937', '486958', '132524', '152830', '341843', '469219', '162421', '153591', '308635', '163899', '357439', '367943', '6', '9', '14', '18', '19', '90', '216', '11', '13', '21', '24', '29', '39', '44', '5', '8', '12', '20', '40', '3753', '6489', '6178', '46610', '98943', '22', '45', '93', '121', '130'])) throw new Error('Scientific validation report is missing the frozen Horizons asteroid batch')
