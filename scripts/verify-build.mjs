...
if (spkDelivery?.ephemerisBodyCount !== 230 || spkDelivery?.planetarySatelliteBodyCount !== 134 || spkDelivery?.smallBodyBodyCount !== 96 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
