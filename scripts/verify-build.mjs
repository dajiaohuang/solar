...
if (spkDelivery?.ephemerisBodyCount !== 55 || spkDelivery?.planetarySatelliteBodyCount !== 31 || spkDelivery?.smallBodyBodyCount !== 24 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== 'd4a531ed0e63879ecacac3354aec6d124f78468fe6cd1aa6c3f54352ff4c996e' || spkDelivery?.pagesManifest?.bytes !== 271115264 || spkDelivery?.pagesManifest?.fileCount !== 519) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== '6293862136e2fc571b25b69c0995189c38b3ded42bbc756f12cc37ee4bd9b5b0' || spkDelivery?.fullManifest?.bytes !== 1149878272 || spkDelivery?.fullManifest?.fileCount !== 519) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
