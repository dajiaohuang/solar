...
if (spkDelivery?.ephemerisBodyCount !== 102 || spkDelivery?.planetarySatelliteBodyCount !== 31 || spkDelivery?.smallBodyBodyCount !== 71 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== 'e068df5fd1127c48db9989adde0cb9c45a494c81c0d1002e203b560542d08693' || spkDelivery?.pagesManifest?.bytes !== 272271360 || spkDelivery?.pagesManifest?.fileCount !== 571) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== 'be63abf5bc360d975251d50dc847ed112f3ca77ccfc07579c65ebc1f69e96565' || spkDelivery?.fullManifest?.bytes !== 1160764416 || spkDelivery?.fullManifest?.fileCount !== 571) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
...
if (JSON.stringify(spkDelivery?.frozenHorizonsAsteroids) !== JSON.stringify(['243', '433', '951', '25143', '99942', '162173', '3200', '3122', '65803', '4179', '1036', '1580', '2867', '52768', '29075', '231937', '486958', '132524', '152830', '341843', '469219', '162421', '153591', '308635', '163899', '357439', '367943', '6', '9', '14', '18', '19', '90', '216', '11', '13', '21', '24', '29', '39', '44', '5', '8', '12', '20', '40', '3753', '6489', '6178', '46610', '98943', '22', '45', '93', '121', '130', '3', '7', '31', '52', '65'])) throw new Error('Scientific validation report is missing the frozen Horizons asteroid batch')
