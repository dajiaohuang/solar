...
if (spkDelivery?.ephemerisBodyCount !== 163 || spkDelivery?.planetarySatelliteBodyCount !== 67 || spkDelivery?.smallBodyBodyCount !== 96 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
