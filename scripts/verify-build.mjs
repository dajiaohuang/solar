...
if (spkDelivery?.ephemerisBodyCount !== 167 || spkDelivery?.planetarySatelliteBodyCount !== 71 || spkDelivery?.smallBodyBodyCount !== 96 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
