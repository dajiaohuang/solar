...
if (spkDelivery?.ephemerisBodyCount !== 220 || spkDelivery?.planetarySatelliteBodyCount !== 124 || spkDelivery?.smallBodyBodyCount !== 96 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
