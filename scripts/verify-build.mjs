...
if (spkDelivery?.ephemerisBodyCount !== 131 || spkDelivery?.planetarySatelliteBodyCount !== 35 || spkDelivery?.smallBodyBodyCount !== 96 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
...
const expectedSatelliteBatches = {
  ...
  jupiter: 'naif:505,naif:506,naif:507,naif:508,naif:509,naif:514,naif:515,naif:516',
