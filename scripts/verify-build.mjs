...
if (spkDelivery?.ephemerisBodyCount !== 248 || spkDelivery?.planetarySatelliteBodyCount !== 152 || spkDelivery?.smallBodyBodyCount !== 96 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== 'b326ba67ab67ad6a00908f6f5f03cb7742346ab48fc7375b8fc5c66dc2354943' || spkDelivery?.pagesManifest?.bytes !== 272921600 || spkDelivery?.pagesManifest?.fileCount !== 602) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== 'f6c06e2c31afb87e184d3dde4060ca18177130198e5b2edf2c18f5f0fb15c5d4' || spkDelivery?.fullManifest?.bytes !== 1167867904 || spkDelivery?.fullManifest?.fileCount !== 602) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
