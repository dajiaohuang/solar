...
if (spkDelivery?.ephemerisBodyCount !== 76 || spkDelivery?.planetarySatelliteBodyCount !== 31 || spkDelivery?.smallBodyBodyCount !== 45 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== '546911d95d7641393ba93a39611b41e3e0603c8c13880988e5fe5f1adb23f2dd' || spkDelivery?.pagesManifest?.bytes !== 271576064 || spkDelivery?.pagesManifest?.fileCount !== 540) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== '8878f28f4ee39b5bbe0d7da17cdebabfe21177b76d3be64b8c5424ad5f699268' || spkDelivery?.fullManifest?.bytes !== 1154207744 || spkDelivery?.fullManifest?.fileCount !== 540) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
...
if (JSON.stringify(spkDelivery?.frozenHorizonsAsteroids) !== JSON.stringify(['243', '433', '951', '25143', '99942', '162173', '3200', '3122', '65803', '4179', '1036', '1580', '2867', '52768', '29075', '231937', '6', '9', '14', '18', '19', '90', '216', '11', '13', '21', '24', '29', '39', '44'])) throw new Error('Scientific validation report is missing the frozen Horizons asteroid batch')
