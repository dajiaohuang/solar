...
if (spkDelivery?.ephemerisBodyCount !== 191 || spkDelivery?.planetarySatelliteBodyCount !== 95 || spkDelivery?.smallBodyBodyCount !== 96 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
