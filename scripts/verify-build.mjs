...
if (spkDelivery?.ephemerisBodyCount !== 179 || spkDelivery?.planetarySatelliteBodyCount !== 83 || spkDelivery?.smallBodyBodyCount !== 96 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
