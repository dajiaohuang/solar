...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== 'f67d436a9820822d6e3287b9a4aab1755f64814b7961622bb0d688041827b797' || spkDelivery?.pagesManifest?.bytes !== 272380928 || spkDelivery?.pagesManifest?.fileCount !== 576) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== 'f33ea643f5b6f9890efc77e593956e3bb2c5cf60416158d254daa1e350f585f5' || spkDelivery?.fullManifest?.bytes !== 1161792512 || spkDelivery?.fullManifest?.fileCount !== 576) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
