...
if (spkDelivery?.ephemerisBodyCount !== 234 || spkDelivery?.planetarySatelliteBodyCount !== 138 || spkDelivery?.smallBodyBodyCount !== 96 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
