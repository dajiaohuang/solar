...
if (spkDelivery?.ephemerisBodyCount !== 208 || spkDelivery?.planetarySatelliteBodyCount !== 112 || spkDelivery?.smallBodyBodyCount !== 96 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
