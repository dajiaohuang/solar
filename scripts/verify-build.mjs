...
if (spkDelivery?.ephemerisBodyCount !== 296 || spkDelivery?.planetarySatelliteBodyCount !== 152 || spkDelivery?.smallBodyBodyCount !== 144 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== 'b81157346e0966f040d7c94ed777ffdbad827881b161a71b588e067faff2f601' || spkDelivery?.pagesManifest?.bytes !== 273965056 || spkDelivery?.pagesManifest?.fileCount !== 650) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== '073e5bdad5faf5d0fdedb1a1dd64b1ebb0e51698c31175e27538c5c6f4baf2aa' || spkDelivery?.fullManifest?.bytes !== 1177687040 || spkDelivery?.fullManifest?.fileCount !== 650) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
