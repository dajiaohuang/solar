...
if (spkDelivery?.ephemerisBodyCount !== 123 || spkDelivery?.planetarySatelliteBodyCount !== 31 || spkDelivery?.smallBodyBodyCount !== 92 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== '28c06405c62b0ba81b16ba071a4d27fe6215a3c896be5f2d71fb730e0dc1c366' || spkDelivery?.pagesManifest?.bytes !== 272862208 || spkDelivery?.pagesManifest?.fileCount !== 598) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== 'e42aaf63bb6f282b161d2c6289a477fb3e6cae7c2abcf3ff9bcd459106dc2715' || spkDelivery?.fullManifest?.bytes !== 1166339072 || spkDelivery?.fullManifest?.fileCount !== 598) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
