...
if (spkDelivery?.ephemerisBodyCount !== 187 || spkDelivery?.planetarySatelliteBodyCount !== 91 || spkDelivery?.smallBodyBodyCount !== 96 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
