...
if (spkDelivery?.ephemerisBodyCount !== 82 || spkDelivery?.planetarySatelliteBodyCount !== 31 || spkDelivery?.smallBodyBodyCount !== 51 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== 'af0a79e8a3bfc1b3e81977110bfb5e323150007e416d2ea228a1ada216228e91' || spkDelivery?.pagesManifest?.bytes !== 271713280 || spkDelivery?.pagesManifest?.fileCount !== 546) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== 'eb9a289bb6edc684324500eb763ce664e08d9e638d80473f389a66b01f7d9355' || spkDelivery?.fullManifest?.bytes !== 1155543040 || spkDelivery?.fullManifest?.fileCount !== 546) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
...
if (JSON.stringify(spkDelivery?.frozenHorizonsAsteroids) !== JSON.stringify(['243', '433', '951', '25143', '99942', '162173', '3200', '3122', '65803', '4179', '1036', '1580', '2867', '52768', '29075', '231937', '486958', '132524', '152830', '341843', '469219', '162421', '6', '9', '14', '18', '19', '90', '216', '11', '13', '21', '24', '29', '39', '44'])) throw new Error('Scientific validation report is missing the frozen Horizons asteroid batch')
