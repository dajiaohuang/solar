...
if (spkDelivery?.ephemerisBodyCount !== 212 || spkDelivery?.planetarySatelliteBodyCount !== 116 || spkDelivery?.smallBodyBodyCount !== 96 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
