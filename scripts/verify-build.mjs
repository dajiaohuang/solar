...
if (spkDelivery?.ephemerisBodyCount !== 242 || spkDelivery?.planetarySatelliteBodyCount !== 146 || spkDelivery?.smallBodyBodyCount !== 96 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
