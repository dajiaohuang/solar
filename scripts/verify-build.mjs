...
if (spkDelivery?.ephemerisBodyCount !== 216 || spkDelivery?.planetarySatelliteBodyCount !== 120 || spkDelivery?.smallBodyBodyCount !== 96 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
