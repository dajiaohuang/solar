...
if (spkDelivery?.ephemerisBodyCount !== 97 || spkDelivery?.planetarySatelliteBodyCount !== 31 || spkDelivery?.smallBodyBodyCount !== 66 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== '141bc03de7ed0f6499b5d3a15040092ed32aeaf2fd80882874c94e83da343394' || spkDelivery?.pagesManifest?.bytes !== 272045056 || spkDelivery?.pagesManifest?.fileCount !== 561) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== 'ca6d49d2982c35863f491cdda8f839e675fb315c01cec99903f5df6808a6ba77' || spkDelivery?.fullManifest?.bytes !== 1158689792 || spkDelivery?.fullManifest?.fileCount !== 561) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
...
if (JSON.stringify(spkDelivery?.frozenHorizonsAsteroids) !== JSON.stringify(['243', '433', '951', '25143', '99942', '162173', '3200', '3122', '65803', '4179', '1036', '1580', '2867', '52768', '29075', '231937', '486958', '132524', '152830', '341843', '469219', '162421', '153591', '308635', '163899', '357439', '367943', '6', '9', '14', '18', '19', '90', '216', '11', '13', '21', '24', '29', '39', '44', '5', '8', '12', '20', '40', '3753', '6489', '6178', '46610', '98943'])) throw new Error('Scientific validation report is missing the frozen Horizons asteroid batch')
