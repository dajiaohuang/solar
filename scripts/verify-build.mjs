...
if (spkDelivery?.ephemerisBodyCount !== 107 || spkDelivery?.planetarySatelliteBodyCount !== 31 || spkDelivery?.smallBodyBodyCount !== 76 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== '2f7b4d2d80c59ad9074ef05bf1fd7b40d3277d6579fd7fa6b52bff26dc800997' || spkDelivery?.pagesManifest?.bytes !== 272471040 || spkDelivery?.pagesManifest?.fileCount !== 580) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== 'c9ea6e7026f5cbae0bd99bba6efce3d4b08f91e310cf8e5fa20d6c97034f274e' || spkDelivery?.fullManifest?.bytes !== 1162620928 || spkDelivery?.fullManifest?.fileCount !== 580) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
