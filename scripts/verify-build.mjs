...
if (spkDelivery?.ephemerisBodyCount !== 309 || spkDelivery?.planetarySatelliteBodyCount !== 152 || spkDelivery?.smallBodyBodyCount !== 157 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== '9628a9d9811fc2edfc77b8dce11b1c1def03ebd5e2a4f10aa04667ba42ce6cf6' || spkDelivery?.pagesManifest?.bytes !== 274250752 || spkDelivery?.pagesManifest?.fileCount !== 663) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== 'c2712bcfa885a6d6a3d091c7fa862dd749aedbebdca8c313c7470055f5bd105e' || spkDelivery?.fullManifest?.bytes !== 1180372992 || spkDelivery?.fullManifest?.fileCount !== 663) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
const expectedSatelliteBatches = {
  ...
  saturn: 'naif:601,naif:602,naif:603,naif:604,naif:605,naif:607,naif:608,naif:609,naif:610,naif:611,naif:612,naif:613,naif:614,naif:615,naif:616,naif:617,naif:618,naif:619,naif:620,naif:621,naif:622,naif:632,naif:633,naif:634,naif:649,naif:653',
...
if (JSON.stringify(spkDelivery?.frozenHorizonsAsteroids) !== JSON.stringify(['243', '433', '951', '25143', '99942', '162173', '3200', '3122', '65803', '4179', '1036', '1580', '2867', '52768', '29075', '231937', '486958', '132524', '152830', '341843', '469219', '162421', '153591', '308635', '163899', '357439', '367943', '6', '9', '14', '18', '19', '90', '216', '11', '13', '21', '24', '29', '39', '44', '5', '8', '12', '20', '40', '3753', '6489', '6178', '46610', '98943', '22', '45', '93', '121', '130', '3', '7', '31', '52', '65', '25', '27', '30', '34', '37', '87', '107', '511', '704', '17', '23', '26', '28', '32', '51', '2060', '5145', '10199', '20000', '15', '88', '624', '911', '33', '35', '36', '38', '41', '46', '48', '49', '2', '4', '10', '16', '15810', '90377', '28978', '225088', '174567', '136472', '55637', '84522', '145451', '145452', '55565', '307261', '208996', '120132', '55636', '15760', '19521', '38083', '38628', '53311', '523794', '50666516', '50760674', '532037', '541132', '50773852', '612911', '471143', '15874', '19308', '42301', '47171', '79360', '84922', '145453', '229762', '7066', '8405', '10370', '944', '60558', '54598', '5335', '31824', '32532', '29981', '52872', '52975', '55576', '37117', '83982', '346889', '42355', '330836', '463368', '696315', '78799', '90568', '58534', '65489', '66652'])) throw new Error('Scientific validation report is missing the frozen Horizons asteroid batch')
if (JSON.stringify(spkDelivery?.frozenHorizonsPrimaryOnly) !== JSON.stringify(['33', '35', '36', '38', '41', '46', '48', '49', '624', '911', '2', '4', '10', '16', '15810', '90377', '28978', '225088', '174567', '136472', '55637', '84522', '145451', '145452', '55565', '307261', '208996', '120132', '55636', '15760', '19521', '38083', '38628', '53311', '523794', '50666516', '50760674', '532037', '541132', '50773852', '612911', '471143', '15874', '19308', '42301', '47171', '79360', '84922', '145453', '229762', '7066', '8405', '10370', '944', '60558', '54598', '5335', '31824', '32532', '29981', '52872', '52975', '55576', '37117', '83982', '346889', '42355', '330836', '463368', '696315', '78799', '90568', '58534', '65489', '66652']) || spkDelivery?.frozenHorizonsPrimaryOnlyBoundary !== 'All frozen Horizons asteroid entries are direct primary heliocentric states only; no companion or system-center state is delivered, and no binary coverage is implied.') throw new Error('Scientific validation report is missing the primary-only Horizons boundary')
