...
if (spkDelivery?.ephemerisBodyCount !== 287 || spkDelivery?.planetarySatelliteBodyCount !== 152 || spkDelivery?.smallBodyBodyCount !== 135 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== 'a8e4da0f052f4657378e4f8409ff3dd8b6bb9637bdccf0b4d2e8f682529b13c4' || spkDelivery?.pagesManifest?.bytes !== 273766400 || spkDelivery?.pagesManifest?.fileCount !== 641) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== 'c7d3f001f67bcf2e930809172a4c2dfc189c3c13a52e8dbbee84cf2369dc7df3' || spkDelivery?.fullManifest?.bytes !== 1175806976 || spkDelivery?.fullManifest?.fileCount !== 641) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
