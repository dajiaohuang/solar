...
if (spkDelivery?.ephemerisBodyCount !== 284 || spkDelivery?.planetarySatelliteBodyCount !== 152 || spkDelivery?.smallBodyBodyCount !== 132 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== '10dbd201f960613aa16452328863649376a7b3db86ba38fd99e37817fc2170a2' || spkDelivery?.pagesManifest?.bytes !== 273701888 || spkDelivery?.pagesManifest?.fileCount !== 638) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== '485fd67299f7da67d35b3ae6ef0ed3e2ce916e2575ae614ca64a2fc7c8a21161' || spkDelivery?.fullManifest?.bytes !== 1175191552 || spkDelivery?.fullManifest?.fileCount !== 638) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
