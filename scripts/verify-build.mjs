...
if (spkDelivery?.ephemerisBodyCount !== 183 || spkDelivery?.planetarySatelliteBodyCount !== 87 || spkDelivery?.smallBodyBodyCount !== 96 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
