...
if (spkDelivery?.ephemerisBodyCount !== 119 || spkDelivery?.planetarySatelliteBodyCount !== 31 || spkDelivery?.smallBodyBodyCount !== 88 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== 'dd0090673d0ff3085a3c861ab68cb5ee3a6550e24c1d4c0c462dc80d1b2baf50' || spkDelivery?.pagesManifest?.bytes !== 272776192 || spkDelivery?.pagesManifest?.fileCount !== 594) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== 'fed08da9adbd7eb1e34ac0458ba7687f08804ad2fc3ad65fd9e31a1c011d4e3c' || spkDelivery?.fullManifest?.bytes !== 1165499392 || spkDelivery?.fullManifest?.fileCount !== 594) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
