...
if (spkDelivery?.ephemerisBodyCount !== 300 || spkDelivery?.planetarySatelliteBodyCount !== 152 || spkDelivery?.smallBodyBodyCount !== 148 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== '4f0c0e721bfd74b68ea234c4be71afd0b599a749e8e6dd9baa0cec51e35ad557' || spkDelivery?.pagesManifest?.bytes !== 274052096 || spkDelivery?.pagesManifest?.fileCount !== 654) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== 'b496a74e55e4bb2943944333ae3362d1cb29ae4e5903021b8f4b39a2057346b9' || spkDelivery?.fullManifest?.bytes !== 1178546176 || spkDelivery?.fullManifest?.fileCount !== 654) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
