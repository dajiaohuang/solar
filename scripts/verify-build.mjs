...
if (spkDelivery?.ephemerisBodyCount !== 238 || spkDelivery?.planetarySatelliteBodyCount !== 142 || spkDelivery?.smallBodyBodyCount !== 96 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
