...
if (spkDelivery?.ephemerisBodyCount !== 253 || spkDelivery?.planetarySatelliteBodyCount !== 152 || spkDelivery?.smallBodyBodyCount !== 101 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
...
if (spkDelivery?.pagesManifest?.id !== 'jpl-satellite-expansion-20260904-pages' || spkDelivery?.pagesManifest?.sha256 !== '3356ba1f76c3413b09b62e31782e5c4c39e80b8b5d54c0c672264cab76ee05ab' || spkDelivery?.pagesManifest?.bytes !== 273031168 || spkDelivery?.pagesManifest?.fileCount !== 607) throw new Error('Scientific validation report is missing the pinned Pages SPK manifest')
if (spkDelivery?.fullManifest?.id !== 'jpl-satellite-expansion-20260904-full' || spkDelivery?.fullManifest?.sha256 !== 'b5ac73f85e2715230e1cb8424de8f177c213ca10216434f1e807a579a61e7c85' || spkDelivery?.fullManifest?.bytes !== 1168885760 || spkDelivery?.fullManifest?.fileCount !== 607) throw new Error('Scientific validation report is missing the pinned full SPK manifest')
