...
if (spkDelivery?.ephemerisBodyCount !== 226 || spkDelivery?.planetarySatelliteBodyCount !== 130 || spkDelivery?.smallBodyBodyCount !== 96 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
