...
if (spkDelivery?.ephemerisBodyCount !== 204 || spkDelivery?.planetarySatelliteBodyCount !== 108 || spkDelivery?.smallBodyBodyCount !== 96 || spkDelivery?.satelliteIdentityCount !== 472) throw new Error('Scientific validation report is missing the expanded SPK coverage counts')
