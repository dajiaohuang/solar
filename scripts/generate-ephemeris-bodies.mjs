...
for (const target of [...new Set(manifest.files.flatMap((f) => f.targets))].sort((a, b) => a - b)) {
  ...
  if (emittedIds.has(generated.id)) continue
  emittedIds.add(generated.id)
