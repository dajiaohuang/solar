...
const cache = process.env.SOLAR_HORIZONS_ASTEROID_BATCH3_CACHE ?? '.cache/horizons-asteroids-batch3-20260909'
const output = 'public/data/ephemerides'
const batch = 'horizons-asteroids-batch3-20260909'
const coreId = 'de440s-2000-01-01-2051-01-01'
const targets = [
  ['hebe', 'Hebe', 6, 20000006],
  ['metis', 'Metis', 9, 20000009],
  ['irene', 'Irene', 14, 20000014],
  ['melpomene', 'Melpomene', 18, 20000018],
  ['fortuna', 'Fortuna', 19, 20000019],
  ['antiope', 'Antiope', 90, 20000090],
  ['kleopatra', 'Kleopatra', 216, 20000216],
]
