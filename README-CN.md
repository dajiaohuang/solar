...
SHA-256 固定、按需加载的 Web/后端 **来源配置**有两种，各含 594 个文件：Pages 配置为 **260.1 MiB**（272,776,192 字节），完整版 Web/后端为 **1111.5 MiB**（1,165,499,392 字节）。当前线上 Pages 预览是另一份精选闭包，仅包含 36 个 SPK 文件、90,717,184 字节；线上容量报告总计 93.2 MiB，不能与 594 文件的 Pages 来源配置混淆。在 UTC JD 2461287.5，来源集成测试确认 **581 个可选天体中心**有 SPK 状态；这不代表原生覆盖或完整离线星历。完整行星卫星新增覆盖 2020–2031 TDB；Pages 将大型卫星文件缩短为 2026–2027。八组新增小天体双星以及八十四份固定 Horizons type-21 小行星快照（Ida、Eros、Gaspra、Itokawa、Apophis、Ryugu、Phaethon、Florence、Didymos、Toutatis、Ganymed、Betulia、Steins、1998 OR2、1950 DA、2001 FO32、Arrokoth、APL、Dinkinesh、2008 EV5、Kamoʻoalewa、2000 ET70、2001 SN263、2005 YU55、2003 SD220、2004 BL86、Duende、Hebe、Metis、Irene、Melpomene、Fortuna、Antiope、Kleopatra、Parthenope、Egeria、Lutetia、Themis、Amphitrite、Laetitia、Nysa、Astraea、Flora、Victoria、Massalia、Harmonia、Cruithne、Golevka、Besixdouze、Torifune、Kalliope、Eugenia、Minerva、Hermione、Elektra、Juno、Iris、Euphrosyne、Europa、Cybele、Phocaea、Euterpe、Urania、Circe、Fides、Sylvia、Camilla、Davida、Interamnia、Thetis、Thalia、Proserpina、Bellona、Pomona、Nemausa、Chiron、Pholus、Chariklo、Varuna、Eunomia、Thisbe、Hektor、Agamemnon）已纳入；后者完整配置覆盖 2020–2031、Pages 覆盖 2026–2027，并保留响应与二进制哈希。新增的四个外太阳系天体（Chiron、Pholus、Chariklo、Varuna）仅提供直接目标中心状态；其 Centaur/TNO 标签只是目录上下文，不代表共享动力学拟合、伴星或实测物性。Eunomia 与 Thisbe 使用直接 Horizons 身份，替代通用 SB441 目标拼写。Hektor 与 Agamemnon 仅提供直接主天体日心状态；不交付伴星或系统中心状态，也不暗示双星覆盖。Bennu 仍明确属于 Horizons 生成缺口。原始 type 2/3/17/21 记录明确绑定各自的来源中心依赖；独立 CSPICE 检查 444 组新增来源池和 1,422 组位置/速度样本；数值一致不等于物理不确定度已评估。
