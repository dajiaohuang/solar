...
describe('shared physical ephemeris integration', () => {
  ...
  it('covers 564 exact body centers and accounts for every remaining identity gap', () => {
    expect(majorBodies.filter((entry) => kernelCoverage(entry, jd).model === 'jpl-spk')).toHaveLength(564)
