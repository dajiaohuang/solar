...
describe('optional SPK body seed artifact', () => {
  it('contains uncovered satellites and all sb441-n16 asteroid targets', () => {
    ...
    for (const number of [2, 3, 4, 7, 10, 15, 16, 31, 52, 65, 87, 88, 107, 511, 704, 17, 23, 26, 28, 32, 51, 2060, 5145, 10199, 20000, 15810, 90377, 28978, 225088, 174567]) expect(ids).toContain(`asteroid:${number}`)
