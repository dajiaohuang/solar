...
describe('optional SPK body seed artifact', () => {
  it('contains uncovered satellites and all sb441-n16 asteroid targets', () => {
    ...
    for (const [naifId, name, kernel] of [[55505, 'S/2003 J12', 'satellite-jup347'], [55506, 'S/2003 J16', 'satellite-jup347'], [55507, 'S/2003 J23', 'satellite-jup347'], [55508, 'S/2003 J24', 'satellite-jup347'], [55509, 'S/2011 J3', 'satellite-jup347'], [55510, 'S/2018 J2', 'satellite-jup347'], [55511, 'S/2018 J3', 'satellite-jup347'], [55512, 'S/2021 J1', 'satellite-jup347'], [55513, 'S/2021 J2', 'satellite-jup347'], [55514, 'S/2021 J3', 'satellite-jup347'], [55515, 'S/2021 J4', 'satellite-jup347'], [55516, 'S/2021 J5', 'satellite-jup347'], [55517, 'S/2021 J6', 'satellite-jup347'], [55518, 'S/2016 J3', 'satellite-jup347'], [55519, 'S/2016 J4', 'satellite-jup347'], [55520, 'S/2018 J4', 'satellite-jup347'], [55521, 'S/2022 J1', 'satellite-jup347'], [55522, 'S/2022 J2', 'satellite-jup347'], [55523, 'S/2022 J3', 'satellite-jup347'], [55524, 'S2025_j_1', 'satellite-jup347'], [55525, 'S/2017 J10', 'satellite-jup347'], [55526, 'S/2017 J11', 'satellite-jup347'], [55527, 'S/2011 J4', 'satellite-jup348'], [55528, 'S/2018 J5', 'satellite-jup348'], [55529, 'S/2024 J1', 'satellite-jup348'], [55530, 'S/2011 J5', 'satellite-jup348'], [55531, 'S/2010 J3', 'satellite-jup349'], [55532, 'S/2010 J4', 'satellite-jup349'], [55533, 'S/2010 J5', 'satellite-jup349'], [55534, 'S/2010 J6', 'satellite-jup349'], [55535, 'S/2011 J6', 'satellite-jup349'], [55536, 'S/2017 J12', 'satellite-jup349'], [55537, 'S/2017 J13', 'satellite-jup349'], [55538, 'S/2017 J14', 'satellite-jup349'], [55539, 'S/2017 J15', 'satellite-jup349'], [55540, 'S/2017 J16', 'satellite-jup349'], [55541, 'S/2017 J17', 'satellite-jup349'], [55542, 'S/2017 J18', 'satellite-jup349'], [55543, 'S/2021 J7', 'satellite-jup349'], [55544, 'S/2021 J8', 'satellite-jup349']] as const) {
      expect(ids).toContain(`naif:${naifId}`)
      expect(bodies.bodies.find((body) => body.id === `naif:${naifId}`)).toMatchObject({ name, parentId: 'jupiter', source: 'jpl-spk-osculating-fallback', sourceKernelId: `${kernel}-${naifId}-2020-2031` })
    }
    for (const number of [2, 3, 4, 7, 10, 15, 16, 31, 52, 65, 87, 88, 107, 511, 704, 17, 23, 26, 28, 32, 51, 2060, 5145, 10199, 20000, 15810, 90377, 28978, 225088, 174567, 136472, 55637, 84522, 145451, 145452]) expect(ids).toContain(`asteroid:${number}`)
    ...
    for (const [id, naifId, batch] of [['asteroid:87', 20000087, 'batch12'], ['asteroid:107', 20000107, 'batch12'], ['asteroid:511', 20000511, 'batch12'], ['asteroid:704', 20000704, 'batch12'], ['asteroid:17', 20000017, 'batch13'], ['asteroid:23', 20000023, 'batch13'], ['asteroid:26', 20000026, 'batch13'], ['asteroid:28', 20000028, 'batch13'], ['asteroid:32', 20000032, 'batch13'], ['asteroid:51', 20000051, 'batch14'], ['asteroid:2060', 20002060, 'batch14'], ['asteroid:5145', 20005145, 'batch14'], ['asteroid:10199', 20010199, 'batch14'], ['asteroid:20000', 20020000, 'batch14'], ['asteroid:15810', 20015810, 'batch19'], ['asteroid:90377', 20090377, 'batch19'], ['asteroid:28978', 20028978, 'batch19'], ['asteroid:225088', 20225088, 'batch19'], ['asteroid:174567', 20174567, 'batch19'], ['asteroid:136472', 20136472, 'batch20'], ['asteroid:55637', 20055637, 'batch20'], ['asteroid:84522', 20084522, 'batch20'], ['asteroid:145451', 20145451, 'batch20'], ['asteroid:145452', 20145452, 'batch20'] ] as const) {
      expect(bodies.bodies.find((body) => body.id === id)).toMatchObject({ naifId, sourceKernelId: expect.stringContaining(batch === 'batch19' ? 'horizons-asteroids-batch19-20260914' : batch === 'batch20' ? 'horizons-asteroids-batch20-20260914' : `horizons-asteroids-${batch}-20260909`) })
    }
  })
