...
describe('optional SPK body seed artifact', () => {
  it('contains uncovered satellites and all sb441-n16 asteroid targets', () => {
    ...
    for (const designation of ['243', '433', '951', '25143', '99942', '162173', '3200', '3122', '65803', '4179', '1036', '1580', '2867', '52768', '29075', '231937', '486958', '132524', '152830', '341843', '469219', '162421', '6', '9', '14', '18', '19', '90', '216', '11', '13', '21', '24', '29', '39', '44', '3753', '6489', '6178', '46610', '98943', '5', '8', '12', '20', '40', '22', '45', '93', '121', '130']) expect(ids).toContain(`asteroid:${designation}`)
