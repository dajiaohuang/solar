...
| Physical ephemerides | Native defaults to the full profile: 499 SHA-pinned SPK files (563.8 MiB), offline and loaded on demand. Web and native share type 2/3/17/21 evaluation and explicit source-specific center pools. Full satellite additions span 2020–2031 TDB; Pages shortens large inner-moon files to 2026–2027 without dropping target identities. Tests resolve 489 selectable centers at UTC JD 2461287.5, not all bodies. Eris/Haumea primary centers end at 2030-01-02 TDB; Makemake retains an approximate fallback. UTC→TT→TDB is supported from 1972; future leap seconds are uncertain. |
