...
| 物理星历 | 原生默认完整配置：499 个 SHA 固定的 SPK 文件（563.8 MiB），离线可用、按需加载。网页和原生共享 type 2/3/17/21 求值与显式来源中心组合。完整包新增卫星覆盖 2020–2031 TDB；Pages 不删目标身份，但将较大内卫星文件缩短为 2026–2027。测试在 UTC JD 2461287.5 解析 489 个可选中心，并非所有星体。Eris/Haumea 主星中心止于 2030-01-02 TDB，Makemake 保留近似回退。UTC→TT→TDB 从 1972 年起可用；未来闰秒不确定。 |
