...
| 物理星历 | 原生默认完整配置：507 个 SHA 固定的 SPK 文件（927.0 MiB），离线可用、按需加载。网页和原生共享 type 2/3/17/21 求值与显式来源中心组合。完整包新增卫星覆盖 2020–2031 TDB；Pages 不删目标身份，但将较大卫星文件缩短为 2026–2027。测试在 UTC JD 2461287.5 解析 502 个可选中心，并非所有星体。Eris/Haumea 主星中心及其卫星止于 2030-01-02 TDB，Makemake 保留近似回退。UTC→TT→TDB 从 1972 年起可用；未来闰秒不确定。 |
| 发布状态 | 仅提供源码和非发布验证路径；未授权、未包含发布签名与商店发布 |

Quaoar/Weywot、Orcus/Vanth、Salacia/Actaea、1998 WW31/Sat1、2001 QW322/Sat1
五组系统在原生完整配置中保留十年原始记录（2020-01-01 至 2030-01-01 TDB）；
