...
private struct NativePreset: Identifiable {
    ...
    static let all: [NativePreset] = [
        ...
        .init(id: "earth-moon", title: "Earth and Moon", reference: "naif:399", ids: ["naif:399", "naif:301", "naif:10"]),
        .init(id: "mars-moons", title: "Mars, Phobos and Deimos", reference: "naif:499", ids: ["naif:499", "naif:401", "naif:402"]),
        .init(id: "jupiter-moons", title: "Jupiter and all bundled moons", reference: "naif:599", ids: ["naif:599", "naif:501", "naif:502", "naif:503", "naif:504", "naif:505", "naif:514", "naif:515", "naif:516"]),
        .init(id: "saturn-moons", title: "Saturn and all bundled moons", reference: "naif:699", ids: ["naif:699", "naif:601", "naif:602", "naif:603", "naif:604", "naif:605", "naif:606", "naif:607", "naif:608", "naif:609", "naif:612", "naif:613", "naif:614", "naif:632", "naif:634"]),
        .init(id: "uranus-moons", title: "Uranus and all bundled moons", reference: "naif:799", ids: ["naif:799", "naif:701", "naif:702", "naif:703", "naif:704", "naif:705"]),
        .init(id: "neptune-moons", title: "Neptune, Triton and Nereid", reference: "naif:899", ids: ["naif:899", "naif:801", "naif:802"]),
        ...
        .init(id: "spk-asteroids", title: "Selected SPK asteroids · Sun reference", reference: "naif:10", ids: ["naif:10", "asteroid:2", "asteroid:3", "asteroid:4", "asteroid:7", "asteroid:10", "asteroid:15", "asteroid:16", "asteroid:31", "asteroid:52", "asteroid:65", "asteroid:87", "asteroid:88", "asteroid:107", "asteroid:511", "asteroid:704"])
    ]
}
