...
- At UTC JD 2461287.5, the integration test resolves **569 selectable centers**. Two registry entries lack SPK states: Makemake and S/2009 S1. Makemake's Horizons fixture does not establish a resolved primary center; S/2009 S1 has no corroborated target number. Seventy asteroid snapshots are frozen Horizons type-21 responses for Ida, Eros, Gaspra, Itokawa, Apophis, Ryugu, Phaethon, Florence, Didymos, Toutatis, Ganymed, Betulia, Steins, 1998 OR2, 1950 DA, 2001 FO32, Arrokoth, APL, Dinkinesh, 2008 EV5, Kamoʻoalewa, 2000 ET70, 2001 SN263, 2005 YU55, 2003 SD220, 2004 BL86, Duende, Hebe, Metis, Irene, Melpomene, Fortuna, Antiope, Kleopatra, Parthenope, Egeria, Lutetia, Themis, Amphitrite, Laetitia, Nysa, Astraea, Flora, Victoria, Massalia, Harmonia, Cruithne, Golevka, 1986 DA, Besixdouze, Torifune, Kalliope, Eugenia, Minerva, Hermione, Elektra, Juno, Iris, Euphrosyne, Europa, Cybele, Phocaea, Euterpe, Urania, Circe, Fides, Sylvia, Camilla, Davida and Interamnia; Bennu remains unavailable because Horizons explicitly reports that pre-computed SPK creation is not available for it. Daphnis uses the original historical SAT393 Type 17 record. Nine other Saturn moons use the distinct modern NAIF SAT415 delivery with its original DE437 dependencies, not the historical SSD container. These are explicit source and coverage boundaries, not absent observed objects.
